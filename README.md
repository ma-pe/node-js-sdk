...
This is a fork of the great oneall-nodejs-sdk (https://github.com/oneall/node-js-sdk). At the moment of forking the original sdk didn't feature the push-api. I therefore added *some* of these api-calls.
